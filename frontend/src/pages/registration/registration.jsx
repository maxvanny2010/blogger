...
import { METHOD, PATH, proxy, requests, ROLE, STORAGE_USER_DATA } from '../../utils/index.jsx';
import { AuthErrorForm, Button, Icon, Input } from '../../component/index.jsx';
import { selectUserRole } from '../../redux/selectors/index.jsx';
import { setUser } from '../../redux/action/index.jsx';
import { useResetForm } from '../../hooks/index.jsx';
